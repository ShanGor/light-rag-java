...
public class LightRagConfig {

    public static final String GRAPH_FIELD_SEP = "<SEP>";
    ...
    public static final class prompts {
        ...
        public static final List<String> process_tickers = List.of("⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏");
        public static final List<String> DEFAULT_ENTITY_TYPES = List.of("organization", "person", "geo", "event", "category");
        public static final String entity_extraction = """
            -Goal-
        ...
        public static final List<String> entity_extraction_examples = List.of("""
            Example 1:
        ...
        public static final String summarize_entity_descriptions = """
            ...
            Output:
            """;
        public static final String entities_continue_extraction = "MANY entities were missed in the last extraction.  Add them below using the same format:";

        public static final String entities_if_loop_extraction = """
            It appears some entities may have still been missed.  Answer YES | NO if there are still entities that need to be added.
            """;
        public static final String fail_response = "Sorry, I'm not able to provide an answer to that question.";
        ...
        public static final List<String> keywords_extraction_examples = List.of("""
            Example 1:
        ...
        public static final String naive_rag_response = """
            ...
            Add sections and commentary to the response as appropriate for the length and format. Style the response in markdown.
            """;
        public static final String similarity_check = """
            ...
            """;
        public static final String mix_rag_response = """
            ---Role---
