...
public class LightRagConfig {
    ...
    static {
        ...
        PROMPTS.put("process_tickers", List.of("⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"));

        PROMPTS.put("DEFAULT_ENTITY_TYPES", List.of("organization", "person", "geo", "event", "category"));

        PROMPTS.put("entity_extraction", """
            -Goal-
        ...
        PROMPTS.put("entity_extraction_examples", List.of("""
            Example 1:
        ...
        PROMPTS.put("summarize_entity_descriptions", """
        ...
        PROMPTS.put("entiti_continue_extraction", "MANY entities were missed in the last extraction.  Add them below using the same format:");

        PROMPTS.put("entiti_if_loop_extraction", """
            It appears some entities may have still been missed.  Answer YES | NO if there are still entities that need to be added.
            """);

        PROMPTS.put("fail_response", "Sorry, I'm not able to provide an answer to that question.");

        PROMPTS.put("rag_response", """
            ---Role---
        ...
        PROMPTS.put("keywords_extraction", """
            ---Role---
        ...
        PROMPTS.put("keywords_extraction_examples", List.of("""
            Example 1:
        ...
        PROMPTS.put("naive_rag_response", """
            ---Role---
